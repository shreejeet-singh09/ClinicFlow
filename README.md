...
Apply `supabase/migrations/0001_CarePair.sql` in the Supabase SQL editor, then seed demo users/profiles from a trusted server-side script using the service role key. Never expose that key to the browser.
